...
void Db::createDB()
{
    ...
    query.exec("CREATE TABLE [SUIVIS] ([ID] INTEGER PRIMARY KEY, [USERS_NAME] VARCHAR REFERENCES [USERS]([NAME]), [EXERCICE_ID] INTEGER REFERENCES [EXERCICES]([ID]), [NOTE] INTEGER;");
